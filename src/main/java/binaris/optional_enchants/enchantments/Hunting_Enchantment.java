...
public class Hunting_Enchantment extends EnchantBuilder {


    public Hunting_Enchantment() {
        super(Enchantment.Rarity.COMMON, EnchantmentTarget.WEAPON, new EquipmentSlot[]{EquipmentSlot.MAINHAND}, 3, false, false, null,
